...
function css() {
    return src("node_modules/bootstrap/dist/css/bootstrap.min.css").pipe(dest(dir_css));
}

function js_bootstrap() {
    return src("node_modules/bootstrap/dist/js/bootstrap.min.js").pipe(dest(dir_js));
}

function js_jquery() {
    return src("node_modules/jquery/dist/jquery.slim.min.js").pipe(dest(dir_js));
}

function js_popper() {
    return src("node_modules/popper.js/dist/umd/popper.min.js").pipe(dest(dir_js));
}
